...
export default function SignupPage() {
  return (
    <div className="flex min-h-[calc(100vh-130px)] items-center justify-center p-4 bg-muted/40">
      <Card className="w-full max-w-md">
        <form action={signup}>
          <CardHeader className="space-y-1">
            <CardTitle className="text-2xl font-bold tracking-tight">Create an account</CardTitle>
            <CardDescription>
              Join Nepal&apos;s largest digital education platform.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="space-y-2">
              <Label htmlFor="full_name">Full Name</Label>
              <Input id="full_name" name="full_name" type="text" placeholder="Ram Bahadur" required />
            </div>
            <div className="space-y-2">
